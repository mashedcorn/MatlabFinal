function roomDescrip(x,map)
    ...
    if locationData == 1 %determines what part of the map your in
    pause(2)
        disp('You are in a desolate hallway with smothstone walls beconing you fourth')%give a description of the room
            if data  >1%determinesif there is a monster present
                pause(2)%pause it to let you read
                disp('a misshapen shadow rushes down the hall, in the torch light it reveals its self to be a')%description of monster showing up
            end
